	...
	<body>
		...
		<div class="col-main">
			...
			<div class="col-right">
				...
				<div id="welcome-info">
					<p>
						你可以直接通过左边的操作面板，添加账户标签，为每个标签设置多个账户，以及激活账户。
					</p>
					<p>
						当前阶段，激活的账户数据没有与个人账户绑定，全部存储于Cookies中，当清空cookies后需要重新设置。
					</p>
					<p>
						当前所有信息由大家公开编辑，请不要随意删改由他人创建的账户信息。
					</p>
				</div>
				<div id="edit-content" >
					<div class="info">
				...
				<div id="add-dialog" class="box">
					...
					<div class="box-bd">
						...
						<input id="add-lbl-name" class="edit" type="text" />
						<p>
							标签说明:
						</p>						<textarea id="add-lbl-describe" class="edit" rows="2" ></textarea>
						<input type="hidden" id="add-lbl-type" value='person' />
						<div style="margin-top: 5px;height: 20px;">
							<input onclick="cancelAddLabel();" class="btn" type="button" value="取消" />
							<input onclick="doAddLabel();" class="btn" type="button" value="提交" />
						</div>
					</div>
